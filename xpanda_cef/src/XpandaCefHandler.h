...
#ifndef CMAKE_CROSS_XPANDACEFHANDLER_H
#define CMAKE_CROSS_XPANDACEFHANDLER_H

#endif //CMAKE_CROSS_XPANDACEFHANDLER_H

// XpandaCefHandler implements CefClient and a number of other interfaces.
